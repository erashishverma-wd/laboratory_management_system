    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-search" style="color: red;"></i>Search By Doctor</h1>
          <!-- DataTales Example -->
        <div class="card shadow mb-4">
          <div class="card-header py-3">
            ...
            <div class="card-body">
              <form class="form-group-user" action="connection.php" method="post">
                <div class="row">
                  <div class="col-sm-4">
                    <select class="form-control" style="color: blue;" name="search" required>
                  ...
                  <div class="col-sm-1">
                    <input type="submit" name="ad_search_btn" class="btn btn-primary btn-block" value="Search">
                  </div>
                </div>
              </form> 
            </div>
