                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <?php
                        ...
                        $query = "SELECT email FROM appointment ORDER BY email";
                        $app = mysqli_query($conn,$query);
                        $apnt = mysqli_num_rows($app);
                        echo "<h1>$apnt</h1>";
                        ?>
                      </div>
                    </div>
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php
                        include('connection.php');
                        $query = "SELECT email FROM eregister ORDER BY email";
                        $emp_num = mysqli_query($conn,$query);
                        $emp = mysqli_num_rows($emp_num);
                        echo "<h1>$emp</h1>"; ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><h1><?php
                        include('connection.php');
                        $query = "SELECT contact FROM report ORDER BY contact";
                        $app = mysqli_query($conn,$query);
                        $apnt = mysqli_num_rows($app);
                        echo "<h1>$apnt</h1>";
                        ?></h1></div>
